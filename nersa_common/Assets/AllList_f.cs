...
public class AllList_f : MonoBehaviour {
    ...
    public List<float> listToHoldinit_data = new List<float>();
    ...
    public void allList( float time, float IDrecord_f, float init_data, float averagefilter, float butterworthfilter, float bayesfilter, float emg_send)
    {   
